	...
	<div id="wrapper">
		...
		<form id="myform">
			...
			<div style="padding: 10px;">
				Kelamin:<br>
				<input type="radio" value="Male" name="gender_male"> Pria<br>
				<input type="radio" value="Female" name="gender_female"> Wanita<br>
			</div>
			<input type="button" value="Sign up" id="signup_button" ><br>
 			...
 			<a href="login.php" style="display: block;text-align: center;text-decoration: none">
 				Sudah Pernah Mengobrol? Masuk Sini...
 			</a>
